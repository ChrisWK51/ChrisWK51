---
title: "CDC Bot: A Python Discord Bot"
...
I coded it in **Python** using the [Discord.py](https://discordpy.readthedocs.io/) library to interact with Discord.
I also used Flask with UptimeRobot to monitor availability.
...
I enjoyed seeing the bot in action, helping with server moderation and bringing some fun to my friends' servers.
I would like to build a new version of the Discord bot along with a Telegram bot in the future.
